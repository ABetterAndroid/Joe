...
public class MyMentionActivity extends ActionBarActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.getItem(0).setTitle(vpMyComment.getCurrentItem()==0? R.string.mention_weibo: R.string.mention_comment);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_my:
			if (vpMyComment.getCurrentItem()==0) {
				...
				item.setTitle(R.string.mention_comment);
			}else {
				vpMyComment.setCurrentItem(0);
				item.setTitle(R.string.mention_weibo);
			}
			break;
		default:
			break;

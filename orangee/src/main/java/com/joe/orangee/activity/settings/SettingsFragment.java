...
import com.joe.orangee.activity.common.WelcomeActivity;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void result) {
                if (logoutResult == 0) {
                    ...
                    StatusesSQLUtils.deleteTableData(new StatusesSQLOpenHelper(getActivity(), Constants.TABLE_NAME_FRIENDS_TIMELINE)
                    .getWritableDatabase());
                    PreferencesKeeper.clearToken(getActivity());
                    SettingsFragment.this.getActivity().finish();
                    SettingsFragment.this.getActivity().sendBroadcast(new Intent("com.joe.orangee.finish"));

                    startActivity(new Intent(SettingsFragment.this.getActivity(), WelcomeActivity.class));
                }
                super.onPostExecute(result);
            }
        }.execute();

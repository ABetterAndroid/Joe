...
import com.joe.orangee.adapter.WeiboStatusAdapter.ViewHolder;
...
public class WeiboListItemUtil {
	...
	public static void getWeiboItem(final Context context, ImageLoader imageLoader, LoadingListener mListener, ParamsChangeLoadingListener mChangeListener, DisplayImageOptions avatarOptions,
			DisplayImageOptions picOptions,final int position, final ViewHolder holder, final WeiboStatus weiboStatus) {
